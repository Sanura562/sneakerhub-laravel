        ...
        <div class="-mx-4 flex flex-wrap justify-between">
            <div class="px-4 my-4 w-full xl:w-1/5">
                ...
                <p class="text-justify">
                    SneakerHub is your go-to destination for premium sneakers, exclusive drops, and the freshest
                    streetwear styles. Whether you’re a seasoned sneakerhead or just starting out, we bring you the
                    latest trends, trusted brands, and a seamless shopping experience—all in one place.
                </p>
            </div>
