    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex space-x-6">
                ...
                <!-- <a href="/addProducts" class="text-gray-700 hover:text-blue-600">Add Product</a> -->
            ...
            <!-- User -->
            <div>
                <a href="/login" class="text-sm font-medium text-blue-600 hover:text-blue-800">Login</a>
            </div>
        </div>
    </div>
</nav>